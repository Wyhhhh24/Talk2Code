...
public class ProjectDownloadServiceImpl implements ProjectDownloadService {
    ...
    public void downloadProjectAsZip(String projectPath, String downloadFileName, HttpServletResponse response) {
        ...
        try {
            ...
            // 最终要把这个文件返回给前端，返回前端的话，直接利用响应流，把我们压缩包生成的压缩文件的流写入到我们返回给前端的响应流中
            // 这样前端就能拿到这个响应流
    ...
    private boolean isPathAllowed(Path projectRoot, Path fullPath) {
        // 根据这两个路径，换算出来一个相对路径，获取相对路径
        // 直接获取到某一个路径相对于完整路径下的一个路径
        // projectRoot 就是这个项目的目录 E:\Javacode\ai-code-master\tmp\code_output\vue_project_350401757895372800
        // fullPath 就是这个目录中的一个文件 E:\Javacode\ai-code-master\tmp\code_output\vue_project_350401757895372800\index.html
        // relativePath 就是 index.html

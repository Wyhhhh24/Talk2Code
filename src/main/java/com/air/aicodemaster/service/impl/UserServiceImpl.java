...
import com.air.aicodemaster.mapper.UserMapper;
...
import static com.air.aicodemaster.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>  implements UserService{
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        user.setUserName("无名");
        user.setUserRole(UserRoleEnum.USER.getValue()); // 默认为用户
    ...
    public LoginUserVO userLogin(String userAccount, String userPassword, HttpServletRequest request) {
        ...
        // 2. 加密
        String encryptPassword = getEncryptPassword(userPassword);
        // 根据账户和密码，查询用户是否存在，也就是即使用户存在，但是密码错误的话，也是不能登录的
        QueryWrapper queryWrapper = new QueryWrapper();
        queryWrapper.eq("userAccount", userAccount);
